...
cmdline = f"readonly=on console=ttyS0 pci=realloc,nocrsm modprobe.blacklist=nouveau nouveau.modeset=0 earlyprintk=serial root=/dev/mapper/root roothash={manifest['root']} tinfoil-config-hash={sha256sum('/config.yml')}"
